...
\author{ANSE Collaboration 
	\thanks{B. Ball, J. Batista, K. De, S. McKee, A. Melo, H. Newman, A. Petrosyan, P. Sheldon, R. Voicu}}
...
In this paper, we present the progress made by ANSE with regards to PhEDEx. We show how
 ...
 as a stand-alone system in other software domains (like ATLAS' PanDA). \st{We will also
 present first results of transfers between CMS sites using this mechanism, and report
 on the stability and performance of PhEDEx when using virtual circuits}
...
\input{section-5-Bibliography.tex}
